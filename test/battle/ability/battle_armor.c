...
SINGLE_BATTLE_TEST("Mold Breaker, Teravolt and Turboblaze ignore Battle Armor and Shell Armor")
{
    ...
    SINGLE_BATTLE_TEST("Battle Armor and Shell Armor halve damage from Rock moves", s16 damage)
{
    u32 ability;
...
SINGLE_BATTLE_TEST("Battle Armor and Shell Armor halve damage from Steel moves", s16 damage)
{
    u32 ability;
    PARAMETRIZE { ability = ABILITY_HYPER_CUTTER; }
    PARAMETRIZE { ability = ABILITY_BATTLE_ARMOR; }
