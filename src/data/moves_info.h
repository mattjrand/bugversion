...
const struct MoveInfo gMovesInfo[MOVES_COUNT_ALL] =
{
    ...
    [MOVE_HEAL_ORDER] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "STATUS and up to half its HP."),
        .effect = EFFECT_RESTORE_HP_STATUS,
        .power = 0,
        .type = TYPE_BUG,
        .accuracy = 0,
        .pp = 10,
    ...
    [MOVE_DARK_VOID] =
    {
        ...
        .power = 0,
        .type = TYPE_DARK,
        .accuracy = B_UPDATED_MOVE_DATA >= GEN_7 ? 75 : 75,
        .pp = 10,
        .target = MOVE_TARGET_BOTH,
        .priority = -1,
        .category = DAMAGE_CATEGORY_STATUS,
    ...
    [MOVE_FELL_STINGER] =
    {
        ...
        .power = B_UPDATED_MOVE_DATA >= GEN_7 ? 60 : 60,
        .type = TYPE_BUG,
        .accuracy = 100,
        .pp = 25,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_STAR_DUSTING] =
    {
        ...
        .description = COMPOUND_STRING(
            "Star dust raises the\n"
            "critical-hit ratio."),
        .effect = EFFECT_STAR_DUSTING,
        .power = 0,
        .type = TYPE_BUG,
        .accuracy = 0,
        .pp = 30,
