...
const struct SpeciesInfo gSpeciesInfoGen9[] =
{
    ...
    [SPECIES_TAROUNTULA] =
    {
        ...
        .abilities = { ABILITY_INSOMNIA, ABILITY_KEEN_EYE, ABILITY_STAKEOUT },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_RELLOR] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_COMPOUND_EYES, ABILITY_STENCH, ABILITY_SHED_SKIN },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_RABSCA] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_TELEPATHY, ABILITY_STENCH, ABILITY_MAGIC_GUARD },
        .bodyColor = BODY_COLOR_GREEN,
