...
const struct SpeciesInfo gSpeciesInfoGen5[] =
{
    ...
    [SPECIES_LEAVANNY] =
    {
        ...
        .baseSpeed     = 102,
        .baseSpAttack  = 70,
        .baseSpDefense = P_UPDATED_STATS >= GEN_6 ? 80 : 80,
        .types = MON_TYPES(TYPE_BUG, TYPE_GRASS),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 250,
    ...
    {
        .baseHP        = 75,
        .baseAttack    = P_UPDATED_STATS >= GEN_6 ? 115 : 115,
        .baseDefense   = 106,
        .baseSpeed     = 112,
        .baseSpAttack  = 55,
        .baseSpDefense = 69,
    ...
    {
        .baseHP        = 95,
        .baseAttack    = P_UPDATED_STATS >= GEN_7 ? 115 : 115,
        .baseDefense   = 125,
        .baseSpeed     = 45,
        .baseSpAttack  = 65,
        .baseSpDefense = 75,
    ...
    [SPECIES_GALVANTULA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_COMPOUND_EYES, ABILITY_SHOCK_THREAD, ABILITY_LIGHTNING_ROD },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_DURANT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_STRONG_JAW, ABILITY_INSPIRE, ABILITY_HUSTLE },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_VOLCARONA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_FLAMING_SCALES, ABILITY_NONE, ABILITY_SWARM },
        .bodyColor = BODY_COLOR_WHITE,
