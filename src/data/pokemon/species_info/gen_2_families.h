...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_SPINARAK] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_POISON_TOUCH, ABILITY_SNIPER, ABILITY_INSOMNIA },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_ARIADOS] =
    {
        ...
        .baseSpeed     = 40,
        .baseSpAttack  = 55,
        .baseSpDefense = P_UPDATED_STATS >= GEN_7 ? 73 : 73,
...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    ...
    [SPECIES_GLIGAR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_LEVITATE, ABILITY_SAND_VEIL, ABILITY_IMMUNITY },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_GLISCOR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_TOXIC_DEBRIS, ABILITY_SAND_FORCE, ABILITY_POISON_HEAL },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_HERACROSS] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_INNER_FOCUS, ABILITY_GUTS, ABILITY_MOXIE },
        .bodyColor = BODY_COLOR_BLUE,
...
#define CORSOLA_DEFENSES (P_UPDATED_STATS >= GEN_7 ? 95 : 85)
    ...
    [SPECIES_CELEBI] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_TRIAGE, ABILITY_NONE, ABILITY_DRIZZLE },
        .bodyColor = BODY_COLOR_GREEN,
