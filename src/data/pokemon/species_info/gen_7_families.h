...
const struct SpeciesInfo gSpeciesInfoGen7[] =
{
    ...
    [SPECIES_CRABRAWLER] =
    {
        ...
        .abilities = { ABILITY_DEFIANT, ABILITY_IRON_FIST, ABILITY_SHELL_ARMOR },
    ...
    [SPECIES_RIBOMBEE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG, EGG_GROUP_FAIRY),
        .abilities = { ABILITY_HOSPITALITY, ABILITY_BOMBS_AWAY, ABILITY_FAIRY_VEIL },
        .bodyColor = BODY_COLOR_YELLOW,
...
#define MINIOR_CORE_SPECIES_INFO(Form, color, iconPal)          \
    ...
    [SPECIES_PHEROMOSA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_DAZE_SCENT, ABILITY_NONE, ABILITY_BEAST_BOOST },
        .bodyColor = BODY_COLOR_WHITE,
