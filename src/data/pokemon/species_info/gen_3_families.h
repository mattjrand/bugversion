...
const struct SpeciesInfo gSpeciesInfoGen3[] =
{
    ...
    [SPECIES_BEAUTIFLY] =
    {
        ...
        .baseDefense   = 70,
        .baseSpeed     = 55,
        .baseSpAttack  = P_UPDATED_STATS >= GEN_6 ? 109 : 109,
        .baseSpDefense = 70,
...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_MASQUERAIN] =
    {
        ...
        .baseAttack    = 50,
        .baseDefense   = 81,
        .baseSpeed     = P_UPDATED_STATS >= GEN_7 ? 85 : 85,
        .baseSpAttack  = P_UPDATED_STATS >= GEN_7 ? 103 : 103,
        .baseSpDefense = 90,
        .types = MON_TYPES(TYPE_BUG, TYPE_WATER),
        .catchRate = 75,
    #if P_UPDATED_EXP_YIELDS >= GEN_7
    ...
    [SPECIES_NINCADA] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_COMPOUND_EYES, ABILITY_TOUGH_CLAWS, ABILITY_RUN_AWAY },
        .bodyColor = BODY_COLOR_GRAY,
